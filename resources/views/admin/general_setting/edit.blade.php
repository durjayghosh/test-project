                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.general.setting') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Header CSS <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="" name="header_css" >{{ isset($result->header_css) ? $result->header_css : old('header_css') }}</textarea>
                                    @if ($errors->has('header_css'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('header_css') }}
                                        </span>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Header Script<span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="" name="header_script">{{ isset($result->header_script) ? $result->header_script : old('header_script') }}</textarea>
                                ...
                                <div class="form-group col-md-6">
                                    <label>Footer Script</footer><span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="" name="footer_script" >{{ isset($result->footer_script) ? $result->footer_script : old('footer_script') }}</textarea>
