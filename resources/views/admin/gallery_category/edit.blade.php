...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row justify-content-between mb-3">
            <div class="col-12 ">
                <h2 class="page-heading">Edit Gallery Category</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.gallery_category.update') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
