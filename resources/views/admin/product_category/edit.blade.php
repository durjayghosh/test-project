                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="{{ route('admin.product_category.update') }}" autocomplete="off"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="meta_heading"
                                            value="{{ $result->meta_heading }}">
                                        @if ($errors->has('meta_heading'))
                                        <span class="invalid-feedback">
                                            {{ $errors->first('meta_heading') }}
                                        </span>
                                        @endif
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="meta_keywords"
                                            value="{{ $result->meta_keywords }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="John Doe"
                                            name="category_name" value="{{ $result->category_name }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="John Doe" name="title"
                                            value="{{ $result->title }}">
                                        @if ($errors->has('title'))
                                        <span class="invalid-feedback">
                                            {{ $errors->first('title') }}
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="description" class="ckeditor" id="" cols="30"
                                            rows="10">{{ $result->description }}</textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        @if($result->image)
                                        <p><img src="{{ asset($result->image) }}" alt="" width="100px;" class="mt-5">
                                        </p>
                                        @endif
                                        @if ($errors->has('image'))
                                        <span class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="John Doe" name="alt_image"
                                            value="{{ $result->alt_image }}">
                                        @if ($errors->has('title'))
                                        <span class="invalid-feedback">
                                            {{ $errors->first('title') }}
                                        </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        @if($result->sub_image)
                                        <p><img src="{{ asset($result->sub_image) }}" alt="" width="100px;"
                                                class="mt-5"></p>
                                        @endif
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Sub image title <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="John Doe" name="alt_sub_image"
                                            value="{{ $result->alt_sub_image }}">
                                        @if ($errors->has('title'))
                                        <span class="invalid-feedback">
                                            {{ $errors->first('title') }}
                                        </span>
