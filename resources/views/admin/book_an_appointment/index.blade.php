...
<div class="content-body">
    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Book An Appointment</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    ...
    <div class="container-fluid">
        <div class="row justify-content-between mb-3">
            <div class="col-12 ">
                <h2 class="page-heading">Manage Book An Appointment</h2>
            </div>
        </div>
...
<script>
    ...
    $(function () {
      var oTable = $('#agent').DataTable({
        ...
        "pageLength":25,
	    ajax: {
          url: '{!! route('admin.BookAnAppointment.indexList') !!}',
        },
		columns: [
  ...
  var detailurl = "{{ route('admin.BookAnAppointment.show', ':id') }}";
