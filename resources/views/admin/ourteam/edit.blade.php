                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="{{ route('admin.ourteam.update') }}" autocomplete="off"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        @if($OurTeams->image)
                                        <p><img src="{{ asset($OurTeams->image) }}" alt="" width="100px;" class="mt-5">
                                        </p>
                                        @endif
                                        @if ($errors->has('image'))
                                        <span class="invalid-feedback">
