                        ...
                        <form method="post" action="{{ route('admin.page.update') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="https://www.youtube.com" name="youtube" value="{{ isset($section->youtube) ? $section->youtube : '' }}">
								...
								else
								{
                                    ...
                                    @if(isset($section->imageone))
                                        <p class="mt-3"><img src="{{ asset($section->imageone) }}" alt="" width="200"></p>
                                    @endif
									<label>Heading <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Heading" name="headingone" value="{{ isset($section->headingone) ? $section->headingone : old('headingone') }}">
                                    @if ($errors->has('headingone'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('headingone') }}
                                        </span>
                                    @endif
									<br>
                                    <label>HAIR EXTENSION</label>
                                   <textarea name="textone" id="textone" class="ckeditor" cols="30" rows="10">{{ isset($section->textone) ? $section->textone : old('textone') }}</textarea>
                                    @if ($errors->has('textone'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('textone') }}
                                        </span>
                                    @endif
                                </div>
								...
								<label>Image </label>
                                    ...
                                    @if(isset($section->imagetwo))
                                        <p class="mt-3"><img src="{{ asset($section->imagetwo) }}" alt="" width="200"></p>
                                    @endif
									<label>Heading <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Heading" name="headingtwo" value="{{ isset($section->headingtwo) ? $section->headingtwo : old('headingtwo') }}">
                                    @if ($errors->has('headingtwo'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('headingtwo') }}
                                        </span>
                                    @endif
									<br>
                                    <label>HAIR WIGS</label>
                                   <textarea name="texttwo" class="ckeditor" id="" cols="30" rows="10">{{ isset($section->texttwo) ? $section->texttwo : old('texttwo') }}</textarea>
                                    @if ($errors->has('texttwo'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('texttwo') }}
                                        </span>
                                    @endif
                                </div>
								...
								<div class="form-group col-md-12">
								<label>Image </label>
                                    <input type="file" name="imagethree" id="">
                                    @if(isset($section->imagethree))
                                        <p class="mt-3"><img src="{{ asset($section->imagethree) }}" alt="" width="200"></p>
                                    @endif
									<label>Heading <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Heading" name="headingthree" value="{{ isset($section->headingthree) ? $section->headingthree : old('headingthree') }}">
                                    @if ($errors->has('headingthree'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('headingthree') }}
                                        </span>
                                    @endif
									<br>
                                    <label>CLOSURE AND TOPPERS</label>
                                   <textarea name="textthree" id="" class="ckeditor" cols="30" rows="10">{{ isset($section->textthree) ? $section->textthree : old('textthree') }}</textarea>
                                    @if ($errors->has('textthree'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('textthree') }}
                                        </span>
                                    @endif
                                </div>
                                ...
                                <div class="form-group col-md-12">
								<label>Image </label>
                                    <input type="file" name="imagefour" id="">
                                    @if(isset($section->imagefour))
                                        <p class="mt-3"><img src="{{ asset($section->imagefour) }}" alt="" width="200"></p>
                                    @endif
									<label>Heading <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Heading" name="headingfour" value="{{ isset($section->headingfour) ? $section->headingfour : old('headingfour') }}">
                                    @if ($errors->has('headingfour'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('headingfour') }}
                                        </span>
                                    @endif
									<br>
                                    <label>MENS HAIR SYSTEM</label>
                                   <textarea name="textfour" class="ckeditor" id="" cols="30" rows="10">{{ isset($section->textfour) ? $section->textfour : old('textfour') }}</textarea>
                                    @if ($errors->has('textfour'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('textfour') }}
                                        </span>
                                    @endif
                                </div>
									<?php
