...
<style>
	...
	.coupon_otp_box.formfield input {
    ...
    <!--<section class="review-banner" style="background-image: url({{ asset(@$PageSections->image) }}) !important;margin: 187px 0px 0px 0px !important;background-repeat: no-repeat !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
	...
	<div style="float:left;width: 100%;">
		<img style="margin: 187px 0px 0px 0px !important;width: 100%;" src="{{ asset(@$PageSections->image) }}">
	</div>
    <section>
        <div class="row">
    ...
    <script>
        ...
        $(document).ready(function(){
            $( "#franchiseFinancialsRoute1" ).submit(function( event ) {
                $('.error_class').hide('active');
				//alert($('#otp_coupan').val());
				if ($('#otp_coupan').val()) {
					var url = "{{ route('contact.submitOtp') }}";
				} else {
					var url = "{{ $franchiseFinancialsRoute }}";
				}
                    ...
                    success: function(response) {
                        ...
                        if(response.error){
                            ...
                            toastr.success(response.success_message);
							 ...
							 $('#Franchise_id').val(response.FranchiseFinancial.id)
