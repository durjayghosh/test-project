...
<div class="maincontainercourses">
	<h2>CAT EYE NAIL ART</h2>
	<div class="initforyou">
			
			<div style="font-size:18px;font-style:normal;" class="initforuoutext">
				<p>Join the online class and get certified in creating classy yet glamorous nail art designs using chrome powder and aurora powder.</p>
			</div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext"><strong>Course Fee: - INR 299/- per student</strong></div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>What will you learn?:-</p>
				<p>Simple & popular designs of chrome nails.</p>
			</div>
	</div>
