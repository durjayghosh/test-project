...
<div class="maincontainercourses">
	...
	<div class="initforyou">
			...
			<div style="font-size:18px;font-style:normal;" class="initforuoutext">
				<p>Join the online class to learn the most captivating, trending and extremely popular cat eye designs.</p>
			</div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext"><strong>Course Fee: - INR 599/- per student</strong></div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>What will you learn?:-</p>
				<p>Types of cat eye gel polish</p>
				<p>Type of magnets</p>
				<p>3 techniques of cat eye nail art.</p>
			</div>
	</div>
