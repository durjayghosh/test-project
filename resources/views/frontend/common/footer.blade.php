    ...
    width: 25px;" loading="lazy" alt="main">
                ...
                <div class="footDtls">
                    ...
                    <a href="mailto:{{ $GeneralSetting->email }}">
                        <span>
                            <img src="{{asset('image/mail.png')}}" alt="main" style="width:100% !important; height:auto !important;">
                        </span>
		...
		<option data-dial_code="ZW" value="263">Zimbabwe (+263)</option>
                            ...
                            <div class="formfield coupon_otp_box" style="display: none;margin-top:5px;">
                                ...
                                <input type="hidden" name="reachus_id" class="reachus_id" id="reachus_id" value="" autocomplete="off">
								 <input type="hidden" name="receivedfrom_add" class="reachus_ids ritu" id="receivedfrom_addID_footer" value="wigomania_main" autocomplete="off">
...
<div class="chat-section">
  ...
  <a class="img-icon-a nofocus" href="https://wigomania.com/reach-us" >
                    <img class="img-icon ccw-analytics" id="style-9" data-ccw="style-9"
                        src="{{ asset('image/reachus.jpeg') }}" alt="WhatsApp chat" loading="lazy">
                </a>
<a target="" href="tel:+919962831281" rel="noreferrer"
                    class="img-icon-a nofocus">
                    <img class="img-icon ccw-analytics" id="style-9" data-ccw="style-9"
                        src="{{ asset('image/cal-but.webp') }}" alt="WhatsApp chat" loading="lazy" >
                </a>
				
                <a target="_blank" href="https://wa.me/+919962831281?text=Hello%20Wigomania" rel="noreferrer"
                    class="img-icon-a nofocus">
                    <img class="img-icon ccw-analytics" id="style-9" data-ccw="style-9"
                       src="{{ asset('image/watsap-but.webp') }}" alt="WhatsApp chat" loading="lazy">
                </a>
            </div>
            </div>
        {{--  <div class="col-md-6 text-end">
            <div class="tawk-chat">
                <img src="{{ asset('frontend/images/tawk.png') }}" alt="WhatsApp chat" loading="lazy">
    </div>
</div> --}}
</div>
</div>
