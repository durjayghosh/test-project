...
<script defer async>
 function loadVideo(container) {
        ...
        iframe.src = 'https://www.youtube.com/embed/UzOoWiJbmmU?autoplay=1&mute=1&loop=1&playlist=UzOoWiJbmmU';iframe.width = '350';  // Width in pixels
	...
	function loadVideodesktop(container) {
        var iframe = document.createElement('iframe');
        iframe.src = 'https://www.youtube.com/embed/UzOoWiJbmmU?autoplay=1&mute=1&loop=1&playlist=UzOoWiJbmmU';iframe.width = '400';  // Width in pixels
