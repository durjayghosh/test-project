...
<head>
	...
	<?php  $currenturl = 'https://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
		if (strpos($currenturl,'ladies-wigs-chennai') !== false) {?>
			<title>Hair wigs for women in chennai</title>
		<?php }else{
			echo '<title>Hair wigs for women in Hyderabad</title>';
		} ?>
	
	<meta name="google-site-verification" content="uXTqgwKJWF6D2opxIR0dYvC_SmV5NWHthuO-lf3uDNU" />
	<meta name="description" content="Wigomania Provide high quality wigs for women ,Instant solution for ladies who suffer from complete hair loss due to medical reasons such as Cancer, chemo and alopecia." />
...
<!-- End Google Tag Manager (noscript) -->
    ...
    @include('frontend.common.model_box')
        ...
        @yield('content')
     @include('frontend.common.footeradswomenwigs')
</body>
</html>