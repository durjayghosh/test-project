...
<div class="popup" style="display: none;">
    ...
    <div class="center_popup">
        <div class="popupscreen">
                    <span class="closePop" onclick="closePop();"><img alt="closepopup" src="{{asset('image/closePop.png')}}" class="lazyloaded" data-ll-status="loaded"><noscript><img
                                src="{{asset('image/closePop.png')}}" alt="closePopImage"></noscript></span>
            <div class="coupontxt">
                <p style="color: black; font-weight: bold;padding:0px 20px">We offers you 15% DISCOUNT OFF MRP + FREE DEMO AND
                    CONSULTATION at any of our hair studios. Kindly
                    complete the form</p></div>
            <div class="DiscountCoupon">
                <div class="imageDiv">
                    <div class="mySlides">
                        <img src="{{asset('image/21.webp'')}}" alt="Hair Extension Shops" class="lazyloaded" data-ll-status="loaded">
                        <noscript><img src="{{asset('image/21.webp'')}}" alt="Hair Extension Shops">
                        </noscript>
                    </div>
                </div>
                    ...
                    <div class="rightdiv">
                        <form class="contactForm" method="post" action="{{ route('contact.reachUsStore') }}" id="formSubmits">
                           ...
                           <div class="formfield PhonECode">
                                ...
                                <span class="error_class full_name_errors" ></span>
                            </div>
                            <div class="formfield PhonECode">
                            ...
                            <div class="formfield">
                                ...
                                <span class="error_class email_errors"></span>
                            </div>
                            <div class="formfield">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="#" id="book_an_appointment">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-new-1" data-bs-dismiss="modal">Close</button>
...
<script src="{{ asset('frontend/js/custom.js') }}" async></script>
<script src="{{ asset('frontend/js/bootstrap.bundle.min.js') }}" async></script>
{{--  <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>  --}}
<script src="https://cdn.jsdelivr.net/npm/popper.js@1.14.7/dist/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous" async></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous" async ></script>
