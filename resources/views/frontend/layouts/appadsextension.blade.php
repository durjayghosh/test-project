...
<head>
	...
	<?php  $currenturl = 'https://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
		if (strpos($currenturl,'hair-extension-chennai') !== false) {?>
			<title>Hair Extension in chennai</title>
		<?php }else{
			echo '<title>Hair Extension in Hyderabad</title>';
		} ?>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    @include('frontend.common.model_box')
        ...
        @yield('content')
     @include('frontend.common.footeradsextension')
</body>
</html>