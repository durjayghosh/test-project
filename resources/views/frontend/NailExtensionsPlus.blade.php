...
<div class="maincontainercourses">
	<h2>NAIL EXTENSIONS PLUS</h2>
	<div class="initforyou">
			<div style="font-size:20px;font-style:normal;" class="initforuoutext">
				<p>Gum Gel Nail Extension Using Dual Tip</p>
				<p>Achieve the Perfect Apex</p>
				<p>Popular shapes & Filing technique of the Extended Nail</p>
				<p>Gum Gel Extension Using Extension Tips</p>
				<p>Overlays with Gum Gel</p>
				<p>Refills with Gum Gel</p>
				<p>Removal of gum gel extensions</p>
			</div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>Russian Manicure</p>
				<p>Ridge Filler Base Coat Overlays</p>
				<p>Optimum Use of the Drill Machine for a Flawless Manicure</p>
				<p>Builder Gel Extensions on Extension Tips</p>
				<p>Inbuilt Glitter and Mylar Extensions</p>
				<p>Builder Gel Refills & Overlays</p>
				<p>Removals of Gel Nail Extensions</p>
				<p>French Manicure</p>
				<p>In-Built French Nails (using Gum Gel & Builder Gel)</p>
			</div>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>Soft Gel Extensions</p>
			</p>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext"><strong>Course Fee: - INR 30,000/- per student</strong></p>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
