...
<div class="maincontainercourses">
	<h2>Professional Nail Artist Course</h2>
	<div class="initforyou">
			
			<p style="font-size:18px;font-style:normal;" class="initforuoutext">Become a certified professional nail artist and explore opportunities in leading salons across the country; become a freelancer or start your own nail spa!</p>
	</div>
	<div class="innermainboxs">
		<div class="innermainboxs1">
				<p style="font-size:24px;font-style:normal;font-weight:600" class="initforuouheading">What’s in it for you?</p>
			<ul>
				<li>100 hours + Exam ( 4 weeks )</li>
				<li>11:30am to 4:30pm on each day.</li>
				<li>75hrs training &amp; practice</li>
				<li>1 intense practice week</li>
				<li>25hrs of intense practice sessions</li>
			</ul>
		</div>
		<div class="innermainboxs2">
				<p style="font-size:24px;font-style:normal;font-weight:500"><strong>Course Inclusions for 4 weeks:-</strong></p>
					<ul>
						<li>Student kit to help kickstart your journey in the nail industry.</li>
						<li>Training Material for the student will be provided at the venue.</li>
						<li>Job assistance with leading salons PAN India</li>
						<li>Certification on successful completion</li>
						<li>10% student discount on Bluesky India gel products</li>
						<li>1 week intense practice sessions, after completing the course.</li>
						<li>Practice week – products and models will be arranged. All practice sessions will be under the supervision of our nail educators only.</li>
					</ul>
		</div>
	</div>
	<div class="headinglearn">
		<p style="font-size:24px;font-style:normal;font-weight:500"><strong>What do you learn</strong></p>
	</div>
	<div class="tabulaerform">
		<div>
				<ul>
					<li>French extensions</li>
					<li>4D gel nail art</li>
					<li>Aurora powder nail art</li>
					<li>In-built extensions using mylars</li>
					<li>Gel paint nail art</li>
					<li>Ombre nail art</li>
					<li>Nail Preparation</li>
					<li>How to evaluate product cost per client</li>
					<li>Manicure techniques</li>
					<li>Weekly (normal) polish application &amp; removal</li>
					<li>How to upsell services</li>
				</ul>
		</div>
		<div>
				<ul>
					<li>Sugar and Sand effect</li>
					<li>Matrix gel nail art</li>
					<li>Cat eye nail art</li>
					<li>Galaxy gel nail art</li>
					<li>Hygiene and sanitization practices</li>
					<li>How to price services</li>
					<li>Gel polish application &amp; removal</li>
					<li>Safe practices for gel removal</li>
					<li>Nail art using stickers &amp; water decals</li>
					<li>Foil gel nail art</li>
					<li>How to click pictures for social media</li>
				</ul>
		</div>
		<div>
			<ul>
				<li>Blossom gel nail art</li>
				<li>Stamping &amp; Aquarelle nail art</li>
				<li>Marble nail art</li>
				<li>Glitter nail art</li>
				<li>Basic strokes and easy geometrical patterns</li>
				<li>Appropriate use of tools</li>
				<li>Optimum utilization of products to minimise wastage</li>
				<li>Russian Manicure</li>
				<li>Chrome nail art</li>
				<li>Animal print nail art</li>
			</ul>
		</div>
		<div>
			<ul>
				<li>Watercolour effect</li>
				<li>Emboss gel nail art</li>
				<li>3D top coat nail art</li>
				<li>Sworovski stones, crystals &amp; jewellery nail art using Décor gel</li>
				<li>In-depth knowledge &amp; use of e-filer (nail drill machine)</li>
				<li>Builder gel extensions, overlays, refills &amp; removals</li>
				<li>Gum gel extensions, overlays, refills &amp; removals</li>
				<li>Soft gel extensions &amp; removals</li>
				<li>Sea shell nail art</li>
				<li>Hard gel overlays, usage for in-built nail art and short extensions</li>
			</ul>
		</div>
	</div>
	<hr>
					...
					<optgroup label="Other countries">
						...
						<option data-dial_code="ZW" value="263">Zimbabwe (+263)</option>
											...
											<div id="">
												...
												<button type="submit" class="btn btn-dark home_form" id="verifyOtpButtoncourses" style="display:none;">Verify OTP</button>
											</div>
