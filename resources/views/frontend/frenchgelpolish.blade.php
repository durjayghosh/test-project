...
<div class="maincontainercourses">
	<h2>FRENCH GEL POLISH</h2>
	<div class="initforyou">
			
			<div style="font-size:18px;font-style:normal;" class="initforuoutext">
				<p>Learn to nail the classic look – French style nails with gel polish</p>
			</div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext"><strong>Course Fee: - INR 899/- per student</strong></div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>What will you learn?:-</p>
				<p>Best base French colour base for different skin tones</p>
				<p>How to create an apex for different lengths</p>
				<p>Use of ridge filler base coats for French base</p>
				<p>Type of French smiles according to a nail length</p>
				<p>How to create perfect French smile</p>
			</div>
	</div>
