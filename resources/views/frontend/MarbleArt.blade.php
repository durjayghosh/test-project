...
<div class="maincontainercourses">
	...
	<div class="initforyou">
			<div style="font-size:20px;font-style:normal;" class="initforuoutext">
				Join our online course to learn a popular nail art trend that embodies individuality and creativity. Each design is unique, showcases depth & creativity.
			</div>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p  style="font-size:20px;margin-bottom: 15px;"><strong>What will you learn :-</strong></p>
				<ul>
					<li>3 techniques of most popular nail art.</li>
					<li>Colour co-ordination for marble nail art.</li>
					<li>Use of gel paints, blossom gel and chrome flakes.</li>
				</ul>
			</div>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext"><strong>Course Fee: - INR 799/- per student</strong></p>
