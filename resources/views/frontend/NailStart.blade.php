...
<div class="maincontainercourses">
	...
	<div class="initforyou">
			<p style="font-size:20px;font-style:normal;" class="initforuoutext">
				<p>Basics of a professional manicure</p>
				<p>Weekly Polish Application.</p>
			...
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				...
				<p>Chrome Nails & Importance of Hard gel.</p>
				<p>Milky White Hard Gel designs</p>
			</p>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>Bluesky Express Nail Art</p>
				<p>Galaxy Nail Art</p>
				<p>Foil Gel Nail Art</p>
				<p>Cat Eye Nail Art</p>
				<p>Blossom Nail Art</p>
				<p>Matrix Gel Nail Art</p>
			</p>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>Introduction to Nail Extensions</p>
				<p>Gum Gel Nail Extension Using Dual Tips</p>
			...
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext"><strong>Course Fee: - INR 12,000/- per student</strong></p>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				<p>COURSE INCLUSIONS:-</p>
				<p>Training material for the student</p>
				<p>Certification on successful completion</p>
				<p>10% student discount on purchase of any gel product.</p>
			</p>
	</div>
