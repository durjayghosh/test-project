                        ...
                        @foreach($blogs as $row)
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    <img class="img-fluid w-100" src="{{asset($row->image)}}" style="object-fit: cover;" alt="{{$row->name}}">
                                    <div class="bg-white border border-top-0 p-4">
                                        <div class="mb-2">
                                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                               href="">{{$row->category?->name ?? ""}}</a>
                                            <a class="text-body" href=""><small>{{$row->created_at->format('d M Y')}}</small></a>
                                        </div>
                                        <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="">{{$row->name}}</a>
