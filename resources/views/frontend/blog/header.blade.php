            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">Website</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">Wigs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">Toppers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">Extensions</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">Men’s Hair Systems</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">Hair Care</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">To Do</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active behind-brand" aria-current="page" href="{{ route('behindTheBrand') }}">Contact us</a>
                        </li>
