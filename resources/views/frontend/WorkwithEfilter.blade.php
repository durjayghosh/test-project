...
<div class="maincontainercourses">
	<h2>BASIC WORK WITH E-FILER</h2>
	<div class="initforyou">
			<div style="font-size:20px;font-style:normal;" class="initforuoutext">
				<p>Have an edge, by learning how to flawlessly use the e-filer (nail polisher/drill machine) for a gorgeous manicure.</p>
			</div>
			<p style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext"><strong>Course Fee: - INR 599/- per student</strong></p>
			<div style="font-size:20px;font-style:normal;margin-top:20px;" class="initforuoutext">
				...
				<p>Types of drill bits.</p>
				<p>How to work the cuticle area.</p>
				<p>How to remove extensions</p>
				<p>Difference between the removal of gel polish & extensions.</p>
