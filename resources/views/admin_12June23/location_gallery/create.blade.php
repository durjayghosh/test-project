...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row justify-content-between mb-3">
            <div class="col-12 ">
                <h2 class="page-heading">Add Location Gallery</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.location_gallery.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-roow">
                                ...
                                <!-- <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="image_title" id="">
