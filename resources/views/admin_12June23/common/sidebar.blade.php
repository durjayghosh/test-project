    ...
    <div class="nk-nav-scroll" style="">
        <ul class="metismenu" id="menu">
            ...
            @if (Auth::user()->role == 1)
                ...
                {{--  <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="icon-user"></i><span class="nav-text">User Management</span></a>
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">Role Management</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">CMS Management</span></a>
                    <ul aria-expanded="false">
                        <li><a href="{{route('admin.page.index')}}">Pages</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">Review</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">Location Gallery</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">Gallery Category</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">Gallery</span></a>
                    <ul aria-expanded="false">
                        <li><a href="{{route('admin.galleries.add')}}">Add Gallery</a></li>
                        <li><a href="{{route('admin.galleries.index')}}">Gallery</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">Our Team</span></a>
                    <ul aria-expanded="false">
                        <li><a href="{{route('admin.ourteam.add')}}">Add Our Team</a></li>
                        <li><a href="{{route('admin.ourteam.index')}}">Our Team</a></li>
                    </ul>
                </li>
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">Partner Opportunity</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="fa fa-user-secret"></i><span class="nav-text">CSR</span></a>
                    <ul aria-expanded="false">
