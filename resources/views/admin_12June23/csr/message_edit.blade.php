                        ...
                        <form method="post" action="{{ route('admin.csr.messageFromCeoIndexListUpdate') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="CEO" name="image_title" value="{{ $Csrs->image_title }}">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <textarea name="message" class="ckeditor" id="" cols="30" rows="10">{{ $Csrs->message }}</textarea>
