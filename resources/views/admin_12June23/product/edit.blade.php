                            ...
                            <form method="post" action="{{ route('admin.product.update') }}" autocomplete="off"
                                ...
                                <div class="form-roow">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="category_id" class="form-control" id="">
                                            ...
                                            <option value="{{ $category->id }}" {{ $Product->category_id ==
                                                $category->id ? 'selected' : '' }}>{{ ucwords($category->category_name)
                                                }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" placeholder="5" name="order_by"
                                ...
                                <div class="form-row sliderAddShow_{{ $key }}">
                                    <div class="form-group col-md-6">
                                        ...
                                        <p class="mt-3"><img src="{{ asset($gallery->gallery) }}" alt="" width="200">
                                        </p>
                                        @endif
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="John Doe"
                                            name="image_title[]" value="{{ $gallery->image_title }}">
                                    ...
                                    <div class="text-right col-md-12">
                                        <button type="button" data-classId="sliderAddShow_{{ $key }}"
                                            data-delete="{{ $gallery->id }}"
                                            class="btn btn-danger deleteSlider">Delete</button>
                                    </div>
