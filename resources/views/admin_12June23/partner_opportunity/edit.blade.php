                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="{{ route('admin.opportunity.update') }}" autocomplete="off"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="John Doe"
                                            name="opportunity" value="{{ $OurTeams->opportunity }}">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="ckeditor" name="about" id="about" cols="30"
                                            rows="10">{{ $OurTeams->about }}</textarea>
                                        @if ($errors->has('about'))
                                        <span class="invalid-feedback">
                                            {{ $errors->first('about') }}
                                        </span>
