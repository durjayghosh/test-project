                        ...
                        <form method="post" action="{{ route('admin.page.update') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <textarea name="description" id="" class="description" cols="30" rows="10">{{ isset($section->description) ? $section->description : old('description') }}</textarea>
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <textarea name="other_description" class="other_description" id="" cols="30" rows="10">{{ isset($section->other_description) ? $section->other_description : old('other_description') }}</textarea>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" name="location" id="" cols="30" rows="2" placeholder="">{{ isset($section->location) ? $section->location : old('location') }}</textarea>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Full Address</label>
                                    <textarea class="form-control" name="address" id="" cols="30" rows="2" placeholder="">{{ isset($section->address) ? $section->address : old('address') }}</textarea>
                                </div>
