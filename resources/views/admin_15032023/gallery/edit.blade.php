                            ...
                            <div class="form-roow">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="about" name="description" id="description" cols="30" rows="10">{!! $Galleries->description !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group col-md-12">
                                       ...
                                       <textarea class="about" name="youtube_description" id="" cols="30" rows="10">{!! $Galleries->youtube_description !!}</textarea>
                                    </div>
                                </div>
