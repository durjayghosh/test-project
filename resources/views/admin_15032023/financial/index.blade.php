...
<div class="content-body">
    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Franchise Financials</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    ...
    <div class="container-fluid">
        <div class="row justify-content-between mb-3">
            <div class="col-12 ">
                <h2 class="page-heading">Manage Franchise Financials</h2>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title">Franchise Financials</h4>
...
<script>
    ...
    $(function () {
      var oTable = $('#agent').DataTable({
        ...
        "pageLength":25,
	    ajax: {
          url: '{!! route('admin.financial.indexList') !!}',
        },
		columns: [
  ...
  var detailurl = "{{ route('admin.financial.show', ':id') }}";
