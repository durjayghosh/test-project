...
<div id="myCarousel" class="carousel slide carousel-fade home-section home-slider" data-bs-ride="carousel">
                ...
                <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                    <div class="row">
                        <div class="col-md-7 slide-left text-end p-0">
                            <img src="{{ asset($Slider->image) }}"  alt="{{$Slider->title_image}}"tltle="hair loss solution" loading="lazy">
                        </div>
            ...
            @if (count($Sliders) > 0)
                @foreach ($Sliders as $key => $Slider)
                 ...
                 <?php
                                    ...
                                    ?>
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        <img class="d-block w-100" src="{{ asset($Slider->image) }}" alt="{{$Slider->title_image}}" title="wigomania uk hair brand
">
                        <div class="carousel-caption banner-div">
