        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 image-col">
                    <p class="text-center"> <img src="{{ asset($Section1->image) }}"alt="{{$Section1->image_title}}" title="wigs" class="family-img"></a>
                </div>
                <div class="col-lg-3">
                        ...
                        @if(count($OurTeams) > 0)
                            @foreach($OurTeams as $key => $value)
                                ...
                                @if($key == 3 )<div class="col-lg-12 mt-2">@endif
                                    <img src="{{ asset($value->image) }}" alt="main" title="extensions" class="animation_img ourteam" data-name="{{ $value->full_name }}" data-designation="{{ $value->designation }}" data-about="{!! $value->about !!}">
