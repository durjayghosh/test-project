...
@section('content')
    <section class="row page-section opportunity-section">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-Mania" role="tabpanel" aria-labelledby="v-pills-Mania-tab"
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <p>
                                    <a href="https:///partner-opportunity#why-wig-o-mania">Know
                                        More</a>
                                </p>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            <img src="{{ asset('frontend/images/oppertunity-bg.webp') }}" alt="main"title=" hair loss solution" width="100%" class="opp_img">
        </div>
    </section>
@endsection
