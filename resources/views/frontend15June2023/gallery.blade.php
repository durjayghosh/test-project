...
<section class="review-banner"  style="background-image: url({{ asset(@$PageSections->image) }});">
            ...
            <div class="container main-container">
                <div class="row gallery_category ">
                    ...
                    <div class="col-lg-6 mt-3">
                        <img src="{{ asset($categoryId->gallery->image) }}" alt="main" title="hyderabad studio" class="gallery_img">
    ...
    {{--  <section class="gallery-section_1" id="second">
        <div class="container">
            <div class="row gallery_category ">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontend/images/g2.jpg') }}"  alt="gallery" title="closure" class="gallery_img">
                </div>
    ...
    <section class="gallery-section" id="third">
        <div class="container">
            <div class="row gallery_category ">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontend/images/g3.jpg') }}" alt="gallery" title="closure" class="gallery_img">
                </div>
                <div class="col-lg-6 gallery-col">
    ...
    <section class="gallery-section_1" id="fourth">
        <div class="container">
            <div class="row gallery_category ">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontend/images/g4.jpg') }}" alt="main" title="toppers" class="gallery_img">
                </div>
                <div class="col-lg-6 gallery-col">
    ...
    <section class="gallery-section" id="five">
        <div class="container">
            <div class="row gallery_category ">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontend/images/g5.jpg') }}" alt="main"  title="scanty hair"class="gallery_img">
                </div>
                <div class="col-lg-6 gallery-col">
    ...
    <section class="gallery-section_1" id="six">
        <div class="container">
            <div class="row gallery_category ">
                <div class="col-lg-6">
                    <img src="{{ asset('frontend/images/g6.jpg') }}" alt="main" title="closure" class="gallery_img">
                </div>
                <div class="col-lg-6 gallery-col">
                    <img src="{{ asset('frontend/images/video_1.png') }}" alt="main"  title="toppers" class="gallery_img1">
                </div>
                <div class="col-lg-6">
