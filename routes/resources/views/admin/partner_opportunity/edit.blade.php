...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row justify-content-between mb-3">
            <div class="col-12 ">
                <h2 class="page-heading">Edit Partner Opportunity</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="card-title">Edit Partner Opportunity</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.opportunity.update') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $OurTeams->id }}">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label>Opportunity<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="John Doe" name="opportunity" value="{{ $OurTeams->opportunity }}">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <textarea class="about" name="ckeditor" id="about" cols="30" rows="10">{{ $OurTeams->about }}</textarea>
                                    @if ($errors->has('about'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('about') }}
                                        </span>
