            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.opportunity.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">

                                <div class="form-group col-md-12">
                                    <label>Opportunity<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="" name="opportunity" value="{{ old('opportunity') }}">
