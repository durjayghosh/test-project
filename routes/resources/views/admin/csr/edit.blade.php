            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.csr.update') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <textarea name="about" class="ckeditor" id="" cols="30" rows="10">{{ $Csrs->about }}</textarea>
                                    @if ($errors->has('about'))
                                        <span class="invalid-feedback">
                                        {{ $errors->first('about') }}
                                        </span>
