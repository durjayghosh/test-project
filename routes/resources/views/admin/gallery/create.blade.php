                                ...
                                <div class="col-md-6">
                                    <div class="form-group col-md-12">
                                        ...
                                        @if ($errors->has('youtube'))
                                            <s="form-group col-md-12">
                                        <labelpan class="invalid-feedback">
                                            {{ $errors->first('youtube') }}
                                            </span>
                                        @endif
                                    </div>

                                    <div class>Youtube Description</label>
                                        <textarea class="ckeditor " placeholder="Youtube Description" name="youtube_description" id="" cols="30" rows="10"></textarea>
                                    </div>
