                            ...
                            <div class="form-roow">
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="datetime-local" class="form-control" name="review_date" value="{{ $result->review_date }}"step="1">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control"  name="rating"  value="{{ $result->rating }}">
