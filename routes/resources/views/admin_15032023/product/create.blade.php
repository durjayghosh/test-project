            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.product.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-roow">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="John Doe" name="product_name" value="{{ old('product_name') }}">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="description" class="form-control description" id="" cols="30" rows="10">{{ old('description') }}</textarea>
