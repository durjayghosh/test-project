...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row justify-content-between mb-3">
            <div class="col-12 ">
                <h2 class="page-heading">Add Role</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.role.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <table>
                                        ...
                                        @foreach($menuList as $list)
                                            <tr>
                                                <td><input type="checkbox" name="menu_id[]" value="{{ $list->id }}" ></td>
