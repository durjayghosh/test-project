...
$ProductCategory = ProductCategory::get();
    ...
    <!--<div class="row">-->
    <!--    <div class="col-lg-6">-->
    <!--        <p class="topbar-para">"Get additional 15% Discount on MRP@Wig-O-Mania. Kindly Fill the coupon to get the discount", Opening Hours : Mon - Sunday (10AM to 7PM</p>-->
    <!--    </div>  -->
    <!--    <div class="col-lg-6">-->
    <!--    </div>  -->
    ...
    <nav class="navbar navbar-expand-md main-nav">
        <div class="container-fluid">
            ...
            <div class="">
                ...
                <!--@if(isset($GeneralSetting->coupon_discount))-->
                <!--    <a href="javascript:void(0);" class="btn btn-outline-light mobile_num">{{ $GeneralSetting->coupon_discount }}</a>-->
                <!--@endif-->
