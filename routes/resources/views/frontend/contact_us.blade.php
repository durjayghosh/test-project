...
<style>
    ...
    <section class="row page-section reach-section contact-section" id="reachSection">
        <div class="col-md-7 page-left p-0">
            <img src="{{ asset('frontend/images/reach.PNG') }}" class="reach_img" alt="...">
        </div>
        <div class="col-md-5 page-right">
            ...
            <form method="POST" action="#" id="formSubmitsReachus"  enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="full_name" value="{{ old('full_name') }}" class="form-control full_names" id="">
                    <span class="error_class full_name_errorss" data-class-name="full_names"></span>
                </div>

                <div class="mb-3">
                    <label for="" class="form-label">WhatsApp Number</label>
                    <input type="tel" name="mobile_number" value="{{ old('mobile_number') }}" class="form-control mobile_numbers" data-class-name="mobile_numbers"  maxlength="10" id="phones_reachus">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" data-class-name="emails" class="form-control emails" id="">
                ...
                <div class="mb-3">
                 ...
                 <div class="mb-3">
                    <label for="" class="form-label">Please solve the following math function: {{ app('mathcaptcha')->label() }}</label>
                ...
                <button type="submit" class="btn btn-light">Send OTP</button>
            </form>
        </div>
    </section>
