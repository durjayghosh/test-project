...
<div class="popup" style="display: none;">
    ...
    <div class="center_popup">
        <div class="popupscreen">
                    <span class="closePop" onclick="closePop();"><img alt="closepopup" src="https://wigomania.com/assets/error_wigomania-child/images/closePop.png" class="lazyloaded" data-ll-status="loaded"><noscript><img
